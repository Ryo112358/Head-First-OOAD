...
public final class FindTennisRacketTests {
	...
	private static void setup() {
		...
		inventory.addTennisRacket("T01", 229.00, "TFight 315 RS", Brand.TECHNIFIBRE, 632.26f, 68.58f, (short) 332, true,
				(byte) 7, (byte) 16, (byte) 19, "Graphite/Dynacore HD");

		// ---| Babolat
		inventory.addTennisRacket("B01", 219.00, "Pure Strike 18x20 3rd Gen", Brand.BABOLAT, 632.26f, 68.58f,
				(short) 323, true, (byte) 4, (byte) 18, (byte) 20, "Graphite");
		inventory.addTennisRacket("B02", 229.00, "Pure Drive Plus 2021", Brand.BABOLAT, 645.16f, 69.85f, (short) 318,
				true, (byte) 6, (byte) 16, (byte) 19, "Graphite");

		// ---| Wilson
		inventory.addTennisRacket("W01", 249.00, "Pro Staff RF97 v13", Brand.WILSON, 625.81f, 68.58f, (short) 357, true,
				(byte) 9, (byte) 16, (byte) 19, "Graphite/Aramid");
		inventory.addTennisRacket("W02", 169.00, "Triad Five", Brand.WILSON, 664.51f, 69.22f, (short) 283, false,
				(byte) 6, (byte) 16, (byte) 20, "Graphite");
		inventory.addTennisRacket("W03", 99.00, "Hyper Hammer 5.3 Stretch OS", Brand.WILSON, 709.68f, 69.85f,
				(short) 255, false, (byte) 8, (byte) 16, (byte) 20, "Graphite/Hyper Carbon");

		// ---| Head
		inventory.addTennisRacket("H01", 189.00, "Graphene 360+ Instinct PWR", Brand.HEAD, 741.93f, 70.36f, (short) 244,
				false, (byte) 9, (byte) 16, (byte) 19, "Graphite/Graphene 360+");
	}
	...
	public final void SearchForProStaff_When_MatchingModelCapitalization_Then_RacketFound() {
		TennisRacketSpec racketCriteria = new TennisRacketSpec("Pro Staff RF97 v13", Brand.WILSON, 0f, 0f, (short) 0,
				true, (byte) 0, (byte) 0, (byte) 0, null);
	...
	public final void SearchForProStaff_When_WrongBrand_Then_RacketNotFound() {
		TennisRacketSpec racketCriteria = new TennisRacketSpec("PRO STAFF RF97 V13", Brand.BABOLAT, 0f, 0f, (short) 0,
				null, (byte) 0, (byte) 0, (byte) 0, null);
	...
	@Test
	public final void SearchForBrand_When_BrandWilson_Then_ReturnWilsonRackets() {
		TennisRacketSpec racketCriteria = new TennisRacketSpec(null, Brand.WILSON, 0f, 0f, (short) 0, null, (byte) 0,
				(byte) 0, (byte) 0, null);
	...
	public final void SearchForModel_When_ModelContainsPure_Then_ReturnPureBabolatRackets() {
		TennisRacketSpec racketCriteria = new TennisRacketSpec("pure", null, 0f, 0f, (short) 0, null, (byte) 0,
				(byte) 0, (byte) 0, null);
	...
	@Test
	public final void SearchForBalance_When_CriteriaHeadLight_Then_ReturnHeadLightRackets() {
		TennisRacketSpec racketCriteria = new TennisRacketSpec(null, null, 0f, 0f, (short) 0, true, (byte) 0, (byte) 0,
				(byte) 0, null);
	...
	@Test
	public final void SearchForStringPattern_When_CriteriaMains16Crosses20_Then_Return16x20Rackets() {
		TennisRacketSpec racketCriteria = new TennisRacketSpec(null, null, 0f, 0f, (short) 0, null, (byte) 0, (byte) 16,
				(byte) 20, null);
